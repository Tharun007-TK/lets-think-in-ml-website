  ...
  return (
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Get in Touch */}
        <section className="text-center py-14 rounded-2xl bg-card border border-border/60 shadow-sm">
          <div className="space-y-6 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-serif font-semibold text-foreground">Get in touch</h2>
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              Have a story, lesson, or experiment that fits Let's Think in Machine Learning? Share your ideas, pitches, or questions—we'd love to hear from you.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              ...
              <a
                href="mailto:hello@letsthinkinmachinelearning.com"
                className="inline-flex items-center justify-center px-8 py-3 rounded-full border border-border text-foreground font-medium hover:border-primary hover:text-primary transition-colors"
              >
                hello@letsthinkinmachinelearning.com
              </a>
            </div>
          </div>
        </section>
