      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl">
                This book is intended to help you grasp machine learning without
                getting lost in jargon and equations. Rather, it’s about
                intuition and real-world thinking and how to apply this in a
                clear fashion, so you don’t just know how it works, but also
                when and why to apply it. It’s about creating strong mental
                models, not rote memory.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                <div className="rounded-xl border border-border bg-card p-4 sm:p-5 space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Learn ML through intuition and examples
                  </p>
                </div>
                <div className="rounded-xl border border-border bg-card p-4 sm:p-5 space-y-1">
                  <h3 className="text-lg font-semibold text-foreground">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Real use-cases over theoretical overload
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="chapters" className="py-10 sm:py-12 lg:py-14 space-y-10">
          ...
          <div className="flex flex-col items-center gap-6 animate-slide-up stagger-1">
            <p className="text-base md:text-lg text-muted-foreground max-w-3xl text-center leading-relaxed">
              A chapter-by-chapter tour of the ideas, tools, and judgment you
              need to work with machine learning confidently.
            </p>
            <MagicBento />
          </div>
        </section>
        ...
        <section className="my-16 md:my-20 rounded-[2.5rem] bg-card p-10 md:p-14 text-center animate-scale-in">
          <div className="max-w-2xl mx-auto space-y-8">
            ...
            <blockquote className="text-2xl md:text-3xl font-bold tracking-tight leading-snug">
              ...
              <br />
              You'll get it by using it, breaking it, and discovering when it
              helps and when it gets in the way."
            </blockquote>
          </div>
        </section>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 max-w-3xl mx-auto text-left">
              ...
              <div className="space-y-3 text-center md:text-left">
                ...
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  Tharun Kumar is a final-year Artificial Intelligence and
                  Machine Learning student who focuses on understanding how
                  models behave in real situations not just how they work on
                  paper. This book comes from hands-on learning, building
                  projects, questioning outputs, and learning where AI helps,
                  where it fails, and how to think clearly when it does.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="my-16 md:my-20 rounded-[2.5rem] bg-card p-10 md:p-14 text-center animate-scale-in">
          <div className="max-w-2xl mx-auto space-y-6">
            <h2 className="text-4xl md:text-5xl font-serif font-semibold tracking-tight leading-tight">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-12 mb-10 md:mb-12 text-base text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="https://letslearn.beehiiv.com/"
                    target="_blank"
