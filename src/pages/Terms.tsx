        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground">
              By accessing or using Let's Think in Machine Learning's website and services, you agree to be bound by
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              Permission is granted to temporarily access the materials on Let's Think in Machine Learning's website
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>To impersonate or attempt to impersonate Let's Think in Machine Learning or any employee</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              All content on Let's Think in Machine Learning, including articles, images, logos, and designs, is the
              property of Let's Think in Machine Learning or its content creators and is protected by international
              copyright laws. 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              The materials on Let's Think in Machine Learning's website are provided on an "as is" basis. Let's Think
              in Machine Learning makes no 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              In no event shall Let's Think in Machine Learning or its suppliers be liable for any damages (including,
              limitation, damages for loss of data or profit, or due to business interruption) arising out of 
              the use or inability to use the materials on Let's Think in Machine Learning's website.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Our website may contain links to third-party websites that are not owned or controlled by Let's Think in
              Machine Learning. 
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Let's Think in Machine Learning may revise these Terms of Service at any time without notice. By using this website, 
